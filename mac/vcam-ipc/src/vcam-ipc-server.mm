...
{
	this->registerFunction(FRAME, std::bind(&VCAM_IPC_Server::frameReady, this, std::placeholders::_1, std::placeholders::_2));

	this->registerFunction(CREATE_DEVICE, std::bind(&VCAM_IPC_Server::deviceCreate, this, std::placeholders::_1, std::placeholders::_2));

	this->registerFunction(REMOVE_DEVICE, std::bind(&VCAM_IPC_Server::deviceDestroy, this, std::placeholders::_1, std::placeholders::_2));

	this->registerFunction(SET_MIRRORING, std::bind(&VCAM_IPC_Server::setMirror, this, std::placeholders::_1, std::placeholders::_2));
}
...
void VCAM_IPC_Server::setMirror(xpc_connection_t, xpc_object_t event)
{
	...
	EMIT(this, MirrorChanged, deviceId, horizontalMirror, verticalMirror)
}
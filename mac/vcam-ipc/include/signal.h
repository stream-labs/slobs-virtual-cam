...
public:                                                                                                                      \
	...
	using CallbackName##Callback = std::pair<void *, CallbackName##CallbackT>;                                           \
                                                                                                                             \
	void connect##CallbackName(void *userData, CallbackName##CallbackT callback)                                         \
	{                                                                                                                    \
		if (!callback)                                                                                               \
			return;                                                                                              \
                                                                                                                             \
		for (auto &func : this->m_##CallbackName##Callback)                                                          \
			if (func.first == userData && func.second == callback)                                               \
				return;                                                                                      \
                                                                                                                             \
		this->m_##CallbackName##Callback.push_back({userData, callback});                                            \
	}                                                                                                                    \
                                                                                                                             \
	void disconnect##CallbackName(void *userData, CallbackName##CallbackT callback)                                      \
	{                                                                                                                    \
		if (!callback)                                                                                               \
			return;                                                                                              \
                                                                                                                             \
		for (auto it = this->m_##CallbackName##Callback.begin(); it != this->m_##CallbackName##Callback.end(); it++) \
			if (it->first == userData && it->second == callback) {                                               \

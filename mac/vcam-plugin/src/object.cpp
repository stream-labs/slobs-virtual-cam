	...
	: ObjectInterface(), m_pluginInterface(pluginInterface), m_parent(parent), m_isCreated(false)
{
	...
	this->m_properties.setProperty(kCMIOObjectPropertyListenerAdded, this->address());
	this->m_properties.setProperty(kCMIOObjectPropertyListenerRemoved, this->address());
...
Object::Object(Object *parent) : ObjectInterface(), m_pluginInterface(parent ? parent->m_pluginInterface : nullptr), m_parent(parent), m_isCreated(false)
{
	this->m_className = "Object";
	this->m_properties.setProperty(kCMIOObjectPropertyOwnedObjects, std::vector<Object *>());
	this->m_properties.setProperty(kCMIOObjectPropertyListenerAdded, this->address());
...
OSStatus Object::propertyChanged(UInt32 numberAddresses, const CMIOObjectPropertyAddress *addresses)
{
